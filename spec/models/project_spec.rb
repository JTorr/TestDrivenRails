...
RSpec.describe Project, type: :model do
  describe "initialization" do
    ...
    it "considers a project with no taks to be done" do
  ...
  describe "velocity" do
    ...
    it "properly estimates a blank project" do
      expect(blank_project.completed_velocity).to eq(0)
      expect(blank_project.current_rate).to eq(0)
      expect(blank_project.projected_days_remaining.nan?).to be_truthy
      expect(blank_project).not_to be_on_schedule
    end
  end
end
